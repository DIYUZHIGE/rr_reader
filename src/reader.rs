...
fn draw_reader_math(display: &mut Display, fonts: &FontSet<'_>, math: &RenderMath) {
...
fn parse_math(source: &str) -> MathNode {
...
fn layout_math(node: &MathNode, fonts: &FontSet<'_>, script: bool) -> MathLayout {
    match node {
...
fn math_text_baseline(font: &Font) -> usize {

...
//   [8..]    index: glyph_count × 12 bytes (codepoint:u32, offset:u32,
//            compressed_size:u16, uncompressed_size:u16 — all LE)
//   [...data blob...]
...
pub fn draw_text_wrapped(
    ...
    for ch in text.chars() {
        ...
        if x + font.glyph_width as usize > max_x {
            x = start_x;
            y += font.glyph_height as usize + line_spacing;
        }
